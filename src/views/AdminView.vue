<template>
  <div class="w-full">
    <div class="">
      <div class="text-center text-5xl">Set up ticket</div>
      <p class="text-center text-3xl mt-5">Customize the contents of the ticket</p>
...
export default {
  data() {
    return {
      ...
      goto: "",
      price: "",
      airlines: ["Air France", "Hainan Airlines", "Qantas Airways", "EVA Air", "Japan Airlines", "Singapore Airlines"],
      fromLocation: ["England", "America", "Canada", "Japan", "Germany", "Australia"],
      toLocation: ["England", "America", "Canada", "Japan", "Germany", "Australia"],
      ticket: [], 
      ShowTicket: [],
    };
  },
